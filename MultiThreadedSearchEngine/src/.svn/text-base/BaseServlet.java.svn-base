...
public class BaseServlet extends HttpServlet {
	...
	public static void prepareResponse(String title,
		...
		out.printf("<body>%n%n");
		out.printf("<center>");
		out.printf("<h1>The Searcher</h1>%n%n");
		out.printf("<img src = \"http://i44.tinypic.com/2dgl3f6.jpg\" width = 500><br><br>");
		out.printf("<a href=\"/welcome\">Home</a> | ");
		out.printf("<a href=\"/login\">Login</a> | ");
		out.printf("<a href=\"/register\">Register</a> | ");
		out.printf("<a href=\"/search\">Search</a> | ");
		// out.printf("<a href=\"/pw\">Change Password</a> | ");
		// out.printf("<a href=\"/history\">Search History</a> | ");
		out.printf("<br><br>");
	}
	...
	public static String getHistory(HttpServletRequest request) {
		Map<String, String> cookies = getCookieMap(request);

		String history = cookies.get("history");
